<div class="container-fluid"> 
	...
	<div class="text-left"> 
		<h2 class="h2 text-gray-900 mb-1"> TAMBAH KEGIATAN RUTIN</h2>
	</div>
	<div class="container">
    <?php if (validation_errors())
     $this->form_validation->set_rules('judul_kegiatan', 'Judul', 'required|trim');
 		 ...
 		 // $this->form_validation->set_rules('gambar_kegiatan', 'Gambar', 'required|trim');
    {?>
   ...
   <!--  <form action="<?php echo base_url()?>Kegiatan_rutin_control/tambah_rutin_aksi" method="post"> -->
	<form class="form-horizontal" method="post" action="<?= site_url('Kegiatan_rutin_control/tambah_rutin_aksi')?>" enctype="multipart/form-data">
