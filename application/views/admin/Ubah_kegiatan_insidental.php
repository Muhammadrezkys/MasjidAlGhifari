<div class="container-fluid">
	<div class="text-left"> 
		<h2 class="h2 text-gray-900 mb-1"> UBAH KEGIATAN INSIDENTAL</h2>
	</div>
	...
	<form class="form-horizontal" method="post" action="<?= site_url('Kegiatan_insidental_control/ubah_kegiatan_aksi/'. $kegiatan->id_kegiatan)?>" enctype="multipart/form-data">
